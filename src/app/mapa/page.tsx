...
export default function MapaPage() {
  return (
    <div className="flex flex-col" style={{ height: "100dvh" }}>
      {/* Top bar */}
      <header className="flex items-center justify-between px-4 py-3 border-b border-earth-deep bg-white/80 backdrop-blur-sm z-20">
        <div className="flex items-center gap-3">
          ...
          <span className="text-earth-deep">|</span>
