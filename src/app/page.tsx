        ...
        <footer className="border-t border-earth-deep py-10 px-6 md:px-12">
          <div className="max-w-[1400px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <a
                href="https://github.com/Soysebalopez/satai"
                className="text-slate-warm hover:text-ink-muted transition-colors"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <span className="text-[10px] font-mono text-slate-warm/60">
                Datos: ESA / NASA / OpenAQ
              </span>
            </div>
          </div>
        </footer>
