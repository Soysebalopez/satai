...
import { FieldsDashboard } from "@/components/agro/fields-dashboard";

export const metadata: Metadata = {
  title: "Agro — MonitorBB",
  description: "Monitoreo NDVI de campos agricolas con imagenes Sentinel-2.",
};
        ...
        <div className="max-w-[1400px] mx-auto flex items-center justify-between px-6 md:px-12 py-3">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-semibold tracking-tight text-ink">
              ...
              <span className="text-xs font-normal text-ink-muted ml-1.5">Agro</span>
            </span>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-[1400px] mx-auto px-6 md:px-12 py-10">
        <div className="max-w-xl mb-10">
          ...
          <p className="text-base text-ink-muted leading-relaxed">
            Sentinel-2 analiza tus campos cada 5 dias. Si el NDVI baja,
            te avisamos antes de que el problema escale.
          </p>
        </div>
